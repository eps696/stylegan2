...
def training_schedule(
    ...
    tick_kimg_dict          = {4:32, 8:28, 16:24, 32:20, 64:16, 128:12, 256:8, 512:6, 1024:4}, # Resolution-specific overrides
    lrate_step              = 1500):
    ...
    s.tick_kimg = tick_kimg_dict.get(s.resolution, tick_kimg_base) * lod_training_kimg / 125 # a la ProGAN
    return s
